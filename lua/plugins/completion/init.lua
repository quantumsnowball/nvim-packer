...
use {
  ...
  config = function()
    local servers = require('plugins.completion.servers')
    -- ensure installed
    ...
    cmp.setup({
      ...
      formatting = {
        ...
        format = function(entry, vim_item)
          ...
          vim_item.menu = (require('plugins.completion.menu_items'))[entry.source.name]
          return vim_item
        end
      },
      mapping = require('plugins.completion.mappings')(cmp, luasnip),
      sources = {
        { name = 'luasnip' },
        { name = 'nvim_lsp' },
        { name = "buffer" },
